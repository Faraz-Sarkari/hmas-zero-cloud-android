...
# Thresholds
BUDGET_CEILING    = _cfg["budget"]
TARGET_PRICE      = _cfg["target"]
WARNING_THRESHOLD = _cfg["warning_threshold"]

# Contact
CONTACT_NUMBER = os.environ.get("ALERT_PHONE_NUMBER") or _cfg.get("contact", {}).get("phone", "")

# Product / plugin selection
PRODUCT_NAME   = _cfg.get("item_label", "Item")
...
# Scheduler
CHECK_TIMES = _cfg.get("schedule", ["08:00", "13:00", "18:00", "21:00"])
